...
import { Plus, Zap, Calendar, TrendingUp, Edit2, Trash2, DollarSign } from 'lucide-react';
...
export const ElectricityReadings: React.FC<ElectricityReadingsProps> = ({
  ...
  const calculateTotalCost = (readings: ElectricityReading[]) => {
    return readings.reduce((sum, reading) => sum + (reading.electricityCost || 0), 0);
  };
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
            ...
            קריאות מונה חשמל ועלויות
          </h3>
          <p className="text-sm text-gray-600 mt-1">
            מעקב אחר קריאות מונה חשמל חודשיות ועלויות לכל כניסה
          </p>
        </div>
        <button
      ...
      {currentBuilding && (
        <div className="grid gap-6">
          {currentBuilding.entrances.map(entrance => {
            ...
            const totalCost = calculateTotalCost(entranceReadings);
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="bg-green-50 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-green-800">סך עלויות</span>
                    </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-gray-800">סך קריאות</span>
                    </div>
                            ...
                            <td className="px-4 py-3">
                              {reading.electricityCost ? (
                                <span className="font-medium text-green-600">
                                  {reading.electricityCost.toLocaleString()}₪
                                </span>
                              ) : (
                                <span className="text-gray-500">-</span>
                              )}
